 ...
 * @date 2018年2月23日
 */
public class WechatConditionalMenuMatchruleResult implements Serializable {
	private static final long serialVersionUID = -2561689274809046878L;
	...
	public String toString() {
		return "WechatConditionalMenuMatchruleResult [tag_id=" + tag_id + ", sex=" + sex + ", client_platform_type="
