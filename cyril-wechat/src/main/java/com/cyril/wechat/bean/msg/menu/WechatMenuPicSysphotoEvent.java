...
public class WechatMenuPicSysphotoEvent extends WechatBaseMsg implements Serializable {
	private static final long serialVersionUID = 137483397348144576L;
	...
	public String toString() {
		return "WechatMenuPicSysphotoEvent [event=" + event + ", eventKey=" + eventKey + ", sendPicsInfo="
				+ sendPicsInfo + "]";
	}
}